...
import { useViewportHeight } from '~/asmlib/hooks/useViewportHeight';
...
export const Menu = forwardRef<ComponentElementType, Menu>(({
	...
	useLayoutEffect(() => {
		...
		if (menuH === 'center') {
			if (anchorH === 'left') horizontalLeft = anchor.left - (menu.horizontalHalf + anchor.horizontalHalf);
			if (anchorH === 'center') horizontalLeft = anchor.left - menu.horizontalHalf;
			if (anchorH === 'right') horizontalLeft = anchor.left - (menu.horizontalHalf - anchor.horizontalHalf);
		}
		...
		if (menuV === 'center') {
			if (anchorV === 'top') verticalTop = anchor.top - (menu.verticalHalf + anchor.verticalHalf);
			if (anchorV === 'center') verticalTop = anchor.top - menu.verticalHalf;
			if (anchorV === 'bottom') verticalTop = anchor.top - (menu.verticalHalf - anchor.verticalHalf);
		}
